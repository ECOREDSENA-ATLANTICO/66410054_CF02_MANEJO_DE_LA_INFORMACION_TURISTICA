  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Generalidades de informes de servicio
    ...
    .tarjeta.tarjeta--gris.p-4
      PasosB.color-primario
        .row.justify-content-center
          h3.text-center Concepto de informes de servicio
        ...
        .row.justify-content-center
          h3.text-center Objetivo del informe
        ...
        .row.justify-content-center
          h3.text-center Importancia del manejo de informes de servicio
          .col-lg-6.col-md-6.align-content-center
            figure
        ...
        .row.justify-content-center
          h3.text-center La importancia de los informes
          .col-lg-6.col-md-6.align-content-center
            figure
        ...
        .row.justify-content-center
          h3.text-center Los beneficios del informe final
          .col-lg-6.col-md-6.align-content-center
            figure
        ...
        .row.justify-content-center
          h3.text-center Instrumentos para evaluar información suministrada
          .col-lg-6.col-md-6.align-content-center
            figure
              img.my-3(src='@/assets/curso/temas/tema2/img5.png', alt='Imagen decorativa')
          .col-lg-6.col-md-12.align-content-center.mb-3.mb-md-0
      ...
      .col-lg-8.col-md-12.mb-5.mb-md-0.align-content-center(data-aos="fade-left")
        LineaTiempoD.color-acento-botones
          ...
          .row.justify-content-center(numero="2" titulo="Índice de satisfacción de clientes externos")
            .col-lg-8.col-md-12.mb-4.mb-md-0.align-content-center
              p Este índice se establece por medio de los conteos que se realizan a los resultados obtenidos en las respuestas de las encuestas y entrevistas a usuarios; dependiendo de su resultado, se hace la interpretación de los datos arrojados. Las empresas deben estar en una constante búsqueda de métodos evaluativos que mejoren el estudio de los servicios turísticos prestados; ya que la calidad y objetividad de su recepción, permiten la toma de decisiones acertadas y pertinentes, para brindar un servicio de calidad.
            .col-lg-4.col-md-8.align-content-center
    ...
    .row.mt-4.mb-4.align-items-center(data-aos="fade-left")
      .col-auto
        img(src='@/assets/curso/temas/tema1/img2.svg', alt='Imagen decorativa')
      .col.px-0
        h3.mb-0 Gráficas e interpretación de encuestas
    ...
    .row.justify-content-center.my-3 
      .col-lg-7 
        ...
        img(src='@/assets/curso/temas/tema2/img14.svg', alt='Se muestra una encuesta realizada a usuarios de los servicios turísticos.')
